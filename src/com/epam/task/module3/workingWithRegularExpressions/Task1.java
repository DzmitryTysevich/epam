...
//        getLengthArrayParagraph(STRING);
//        getLengthArrayParagraph(STRING);
//    }
//
//    public static int getLengthArrayParagraph(String string) {
...
//    }
//
//    public static void getArrayAmountSentences(String string) {
//        int lengthArrayParagraph = getLengthArrayParagraph(string);
//        int [] arrayAmountSentences = new int[lengthArrayParagraph];
//        Pattern pattern = Pattern.compile("[!?.]");
//        Matcher matcher = pattern.matcher(string);
//        while (matcher.find()) {
